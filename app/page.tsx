...
export default function Home() {
  ...
  return (
    <Shell>
      ...
      {tab === "coach" && (
        <div className="mt-5 space-y-4 sm:mt-7 sm:space-y-5">
          <section><div className="text-[11px] font-black uppercase tracking-[0.18em] text-black/40">COACH</div><h2 className="mt-1 text-4xl font-black tracking-[-0.06em]">러닝 코치</h2><p className="mt-2 text-sm font-bold text-black/45">오늘 데이터와 최근 훈련을 바탕으로 정리한 코칭 내용입니다.</p></section>
          <section className="rounded-[20px] border border-black/10 bg-white p-4 sm:p-6">
